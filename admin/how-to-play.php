                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="content" rows="5" class="form-control"><?php echo $row['howtoplay']; ?></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <?php
                  if(isset($_POST['submit'])){
                    ...
                    $content = $_POST['content'];
                     $update = mysqli_query($con, "UPDATE `content` SET `howtoplay`='$content'");
                      if($update){
