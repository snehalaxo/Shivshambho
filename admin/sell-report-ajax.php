    ...
    ?>
       ...
       <div class="row" style="margin-top:30px;">
                  ...
                  <div class="container-fluid colls">
                      ...
                      $query = mysqli_query($con,"select sum(amount) as total from games where bazar='$market2' AND number='".$data['double_pana']."' AND date='$date'");
                      if(mysqli_num_rows($query) > 0){
                        $get_q = mysqli_fetch_array($query);
                        if($get_q['total'] == null){
                            $get_q['total'] = "0";
                      ...
                      $query = mysqli_query($con,"select sum(amount) as total from games where bazar='$market2' AND number='".$data['triple_pana']."' AND date='$date'");
                      if(mysqli_num_rows($query) > 0){
                        $get_q = mysqli_fetch_array($query);
                        if($get_q['total'] == null){
                            $get_q['total'] = "0";
